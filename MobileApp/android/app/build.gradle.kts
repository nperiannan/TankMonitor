...
android {
    namespace = "com.tankmonitor.tank_monitor"
    ...
    defaultConfig {
        ...
        applicationId = "com.tankmonitor.tank_monitor"
    ...
    buildTypes {
        release {
            // Use the stable release keystore when configured (key.properties present);
